...
* [J] <strong>Liu, S.</strong> and Tanwani, A. (2023). Impulsive switching signals with functional inequalities: Stability analysis using hybrid systems framework. Accepted by Automatica.
...
On motion planning
------
* [C] Chen, J., <strong>Liu, S.</strong> (2024). Motion Planning for Control-Affine Systems by Geometric Heat Flow with Fine-Tuning. Submitted to the 7th IEEE International Conference on Unmanned Systems.
